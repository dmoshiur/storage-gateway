  ...
  return (
    <main className="grid min-h-screen bg-gradient-to-br from-ngo-50 via-slate-50 to-white lg:grid-cols-2">
      <section className="hidden bg-ink-900 p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="max-w-md"><p className="text-sm font-bold uppercase tracking-[0.2em] text-ngo-100">Private gateway</p><h1 className="mt-4 text-4xl font-bold leading-tight">Protect the documents that support your mission.</h1><p className="mt-5 leading-7 text-slate-300">A focused, private workspace for authorized staff to retain, find, and safely manage NGO document records.</p></div>
