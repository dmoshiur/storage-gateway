    ...
    <main className="grid min-h-screen bg-gradient-to-br from-ngo-50 via-slate-50 to-white lg:grid-cols-2">
      ...
      <section className="flex items-center justify-center p-5 sm:p-10">
        <div className="w-full max-w-md">
          ...
          <div className="panel p-6 sm:p-8"><p className="text-sm font-semibold uppercase tracking-wider text-ngo-600">Administrator access</p><h1 className="mt-2 text-2xl font-bold text-ink-900">Sign in to storage</h1><p className="mt-2 text-sm leading-6 text-slate-600">Use your authorized Firebase account. Unauthenticated visitors cannot access documents or settings.</p><div className="mt-7"><LoginForm /></div></div>
        </div>
      </section>
    </main>
  );
