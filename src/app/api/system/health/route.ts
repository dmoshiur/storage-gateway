  ...
  return apiRoute(request, async (requestId) => {
    ...
    return success({
      ...
      services: {
        ...
        blobStorage: { status: blob.reachable ? "healthy" : "degraded", latencyMs: blob.latencyMs, checkedAt: blob.checkedAt, authMode: blob.authMode ?? null, ...(blob.error ? { error: blob.error } : {}) },
